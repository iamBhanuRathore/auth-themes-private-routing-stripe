    ...
    <>
      <nav className="relative px-4 py-4 flex justify-between items-center text-primaryText-1 bg-primary-1">
        ...
        {status === "authenticated" && (
          <Button
            onClick={() => signOut()}
            className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-gray-100 font-bold  rounded-xl transition duration-200">
            Sign Out
          </Button>
        )}
